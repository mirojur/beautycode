   ...
   <div class="navbar-wrapper">  
    ...
    <div id="myCarousel" class="carousel slide">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <div class="featurette">
                ...
                <h2 class="featurette-heading"><?php echo get_the_title($mychild);  ?></h2>
                <p class="lead"><?php echo $mychild->post_content; ?></p>
              </div>
      ...
      <hr class="featurette-divider">
              ...
              <div class="featurette">
                <img class="featurette-image pull-right" src="http://getbootstrap.com/2.3.2/assets/img/examples/browser-icon-chrome.png">
                <h2 class="featurette-heading">aber hallo</h2>
                <p class="lead">alskdjfkaösldk jaklsdjföasl jsakdlf jasöldjföas dfjaösldjflask dfjasdöf jasödkfjöa</p>
              </div>
